...
import { setFormDetails, setUserModalStatus, setVehicleModalStatus } from '../../../../redux/features/shared/sharedSlice';
...
function VehicleModal() {
  ...
  const userFormik = useFormik({
    ...
    onSubmit: (values: any) => {
      ...
      dispatch(setVehicleModalStatus(false))
  ...
  return (
    <>
      ...
      <Modal show={sharedActions.vehicleModal} onHide={closeModal} animation={true}>
